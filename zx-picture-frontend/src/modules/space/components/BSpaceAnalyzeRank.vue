  ...
  <n-card title="空间使用量 Top 10 排名">
    <n-tabs type="line" animated>
      <n-tab-pane name="chart" tab="图表展示">
        <v-chart class="chart-box" :option="chartOption" autoresize />
      </n-tab-pane>
...
import { analyzeSpaceRankUsingGet } from '@/services/api/spaceAnalyzeController.ts'
import { bytesToMB, formatSize } from '@/shared/utils/util.ts'
