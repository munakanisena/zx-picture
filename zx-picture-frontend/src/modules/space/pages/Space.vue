<template>
  <div style="padding: 24px">
    ...
    <n-flex align="center" justify="space-between" style="height: 100%">
      ...
      <n-card title="空间使用情况" size="small" collapsible>
        <n-flex vertical>
          <div>
            ...
            <n-progress
              type="line"
              :percentage="(spaceInfo?.maxSize ? ((spaceInfo.usedSize / spaceInfo.maxSize) * 100).toFixed(1) : 0)"
          ...
          <div>
            ...
            <n-progress
              type="line"
              :height="24"
              :percentage="(spaceInfo?.maxCount ? ((spaceInfo.usedCount / spaceInfo.maxCount) * 100).toFixed(1) : 0)"
              status="success"
              processing
              :indicator-placement="'inside'"
              :color="themeVars.successColor"
      ...
      <!--搜索栏-->
      <n-card :bordered="false" :key="searchKey">
