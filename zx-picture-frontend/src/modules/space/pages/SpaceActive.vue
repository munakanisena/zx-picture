...
import { activeSpaceUsingPost } from '@/services/api/spaceController.ts'
import { computed, onMounted, ref } from 'vue'
import { SPACE_LEVEL_ENUM, SPACE_LEVEL_LIST, SPACE_TYPE_ENUM } from '@/shared/constants/space.ts'
