...
import { deleteUserUsingPost, getUserPageListAsManageUsingPost } from '@/services/api/userController'
import BUserUpdateModal from '@/modules/admin/components/BUserUpdateModal.vue'
import { toOptions } from '@/shared/utils/util.ts'
import { USER_ROLE_MAP, USER_STATE_MAP, USER_VIP_MAP } from '@/shared/constants/user.ts'
...
// 初始化
const searchParams = reactive<API.UserQueryRequest>({ ...initialSearchParams })
